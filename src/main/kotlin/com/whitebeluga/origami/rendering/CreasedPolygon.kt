...
internal class CreasedPolygon (vertices: List<Point>, colors: ColorCombination,
                     val creases: Set<Crease> = emptySet()):
        Polygon(vertices, colors) {
   companion object {
      fun fromFace(face: Face) = CreasedPolygon(face.vertices, face.colors, face.creases)
   }
}